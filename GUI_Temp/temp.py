...
class Temp(customtkinter.CTkFrame):
    ...
    def create_first_row(self):
      ...
      self.label = customtkinter.CTkLabel(self, text="Temperature", bg_color="#072e0a", fg_color="#072e0a", text_font=("Arial", 23, "bold"), text_color="white")
    ...
    def create_max_frame_row(self):
      self.max_frame = customtkinter.CTkFrame(self, bg_color="#072e0a", fg_color="#1c5b20", corner_radius=10, width=100)
      ...
      self.max_value_lbl = customtkinter.CTkLabel(self.max_frame, text=f"{self.max_value}°F", bg_color="#1c5b20", fg_color="#1c5b20", text_font=("Arial", 25, "bold"), text_color="white", width=10)
    ...
    def create_min_frame_row(self):
      self.min_frame = customtkinter.CTkFrame(self, bg_color="#072e0a", fg_color="#1c5b20", corner_radius=10, width=100)
      ...
      self.min_label.grid(row=0, column=0, sticky="nsew", padx=10, pady=0)
      self.min_value_lbl = customtkinter.CTkLabel(self.min_frame, text=f"{self.min_value}°F", bg_color="#1c5b20", fg_color="#1c5b20", text_font=("Arial", 25, "bold"), text_color="white", width=10)
    ...
    def create_middle_frame(self):
      self.mid_frame = customtkinter.CTkFrame(self, bg_color="#072e0a", fg_color="#1c5b20", corner_radius=10, width=250)
      ...
      self.value_lbl = customtkinter.CTkLabel(self.value_frame, text=f"{self.value}°F", bg_color="#1c5b20", fg_color="#1c5b20", text_font=("Arial", 35, "bold"), text_color="white", width=10)
      self.value_lbl.grid(row=2, column=0, sticky="nsew", padx=0, pady=0)
      self.value_image = customtkinter.CTkLabel(self.value_frame, image=self.temp_image, text="", bg_color="#1c5b20", fg_color="#1c5b20", width=10)
    ...
    def increase_min_val(self):
      if self.min_value < self.max_value:
        self.min_value += 1
        self.min_value_lbl.config(text=f"{self.min_value:02}°F")
    ...
    def increase_max_val(self):
      if self.max_value < 100:
        self.max_value += 1
        self.max_value_lbl.config(text=f"{self.max_value:02}°F")
    ...
    def increase_val(self):
      if self.value < self.max_value:
        self.value += 1
        self.value_lbl.config(text=f"{self.value:02}°F")
